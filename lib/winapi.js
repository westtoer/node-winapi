...
GenericQuery.prototype.requirePubChannel = function () {
    return this.andField("publishing_channels.publishing_channel.code");
};
...
GenericQuery.addQueryVal = function (set, key, value) {
    ...
    if (Array.isArray(value)) {
        value.forEach(function (v) {
            GenericQuery.addQueryVal(set, key, v);
        });
    } else {
...
GenericQuery.prototype.getURI = function (client, notoken) {
    ...
    GenericQuery.addQueryVal(q, "metadata.update_date", this.lastmodExpr);
    GenericQuery.addQueryVal(q, "metadata.deleted", this.softDelState);
    GenericQuery.addQueryVal(q, "publishing_channels.published", this.pubState);
    GenericQuery.addQueryVal(q, "metadata.id", this.selectId);
    GenericQuery.addQueryVal(q, "_exists_", this.requiredFields);

    GenericQuery.addQueryList(q, "publishing_channels.publishing_channel.code", this.channels);
    GenericQuery.addQueryList(q, "metadata.touristic_product_type.code", this.touristictypes);
