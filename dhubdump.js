...
var wapi = require('./lib/winapi'),
    ...
    TOURTYPES = ["hotel", "bed_breakfast", "camping", "minicamping", "camping_grounds", "residence_park", "hiking_cabin",
                 "holiday_park", "youth_accommodation", "holiday_centre", "holiday_cottage", "holiday_accommodation", "belfry",
                 "historic_building", "monument", "religious_building", "forest", "domain", "park_garden", "battle_field_tour",
                 "belgian_cemetery", "commonwealth_cemetery", "german_cemetery", "french_cemetery", "american_cemetery",
                 "front_flight", "war_site", "cinema", "visitor_centre", "casino", "cultural_centre", "childrens_farm", "museum",
                 "shop_store", "wellness", "brewery", "farm_to_taste", "distillery", "vineyard", "bike_rental", "covered_wagon",
                 "riding_school", "adventure", "golf", "sport_accommodation", "swimming", "scooter_solex_rental", "dock",
                 "boat_rental", "marina", "canoe_kayak_rental", "beach_club", "theme_park", "amusement_park", "playground",
                 "tourist_office", "bistro", "cafe", "restaurant", "tearoom", "concert", "festival", "temporary_offering_biking",
                 "film", "commemorative_ceremony", "ice_rink", "shopping", "special_market", "sports", "procession", "exhibition",
                 "theater", "fireworks", "walking", "temporary_offering_water_recreation", "weekly_market", "undefined", "room"],
...
dumps = settings._ && settings._.length ? settings._ : ['vocs', 'products'];
